...
<div class="managesubjects">
    ...
    <form action="../ManageSubject" method="post">
        ...
        <input type="text" name="collectionCode" required >
        <p style="color: red;">
Note :
</p>
<ul>
<li>Add Subject Name Properly. You can't Modify It</li>
<li>Don't use whitespace while giving subjectname</li>
<li>Subject Name and Subject Code both are required.</li></ul><br>
