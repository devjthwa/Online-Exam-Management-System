...
public class UpdateFaculty extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        collection = database.getCollection("facultylogin"); // Replace with your collection name
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String facultyemail = request.getParameter("email"); // Get the _id parameter

        try {

            // Retrieve data from MongoDB using the _id
            Document query = new Document("email", facultyemail);
            ...
            if (document != null) {
                ...
                out.print("<h2>Update Faculty Details </h2>");
                out.print("<div class= 'facultymanage'><form action='UpdateFaculty' method='post'>");
